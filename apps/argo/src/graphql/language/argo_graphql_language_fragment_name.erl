...
%%%-----------------------------------------------------------------------------
%%% % @format
-module(argo_graphql_language_fragment_name).
...
-type t() :: #argo_graphql_language_fragment_name{}.
...
parse(_Context = #{name := Name}, Location) when is_binary(Name) ->
    #argo_graphql_language_fragment_name{
        location = Location,
        name = Name
    }.
...
format(Formatter1, #argo_graphql_language_fragment_name{name = Name}) ->
