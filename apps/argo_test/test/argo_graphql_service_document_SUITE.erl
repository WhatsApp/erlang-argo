...
%%%-----------------------------------------------------------------------------
%%% % @format
-module(argo_graphql_service_document_SUITE).
...
%% Test Cases
-export([
    prop_roundtrip_service_document/0,
...
prop_roundtrip_service_document() ->
    [
        {doc, "Loads the `argo_graphql_service_document' and runs property tests for formatter/parser."},
