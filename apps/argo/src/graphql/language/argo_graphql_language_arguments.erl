...
%%%-----------------------------------------------------------------------------
-module(argo_graphql_language_arguments).
-moduledoc """
...
-type t() :: #argo_graphql_language_arguments{}.
...
-spec parse(Context, Location) -> Arguments when
    Context :: context(), Location :: erl_anno:location(), Arguments :: t().
parse(_Context = #{arguments := Arguments = [#argo_graphql_language_argument{} | _]}, Location) ->
    #argo_graphql_language_arguments{
        location = Location,
        arguments = Arguments
    }.
...
format(Formatter1, #argo_graphql_language_arguments{arguments = Arguments}) ->
    ...
    {_Index, Formatter4} = lists:foldl(
        fun(Argument, {Index, Formatter3_Acc1}) ->
            ...
            Formatter3_Acc4 = argo_graphql_language_argument:format(Formatter3_Acc3, Argument),
            Formatter3_Acc5 =
