...
%%%-----------------------------------------------------------------------------
%%% % @format
-module(argo_graphql_language_enum_value_definition).
...
-type t() :: #argo_graphql_language_enum_value_definition{}.
...
-spec parse(Context, Location) -> EnumValueDefinition when
    Context :: context(), Location :: erl_anno:location(), EnumValueDefinition :: t().
parse(Context = #{value := EnumValue = #argo_graphql_language_enum_value{}}, Location) ->
    OptionDescription =
    ...
    #argo_graphql_language_enum_value_definition{
        location = Location,
        value = EnumValue,
...
format(Formatter1, #argo_graphql_language_enum_value_definition{
    value = EnumValue,
    description = OptionDescription,
    directives = OptionDirectives
}) ->
    ...
    Formatter3 = argo_graphql_language_enum_value:format(Formatter2, EnumValue),
    Formatter4 =
