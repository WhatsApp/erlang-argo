...
-spec write_nullable_type(CoreWriter, NullableType, IsLabeled) -> CoreWriter when
    CoreWriter :: t(), NullableType :: argo_core:nullable_type(), IsLabeled :: boolean().
write_nullable_type(W = #argo_core_writer{}, null, IsLabeled) when is_boolean(IsLabeled) ->
    write_label(W, ?ARGO_LABEL_MARKER_NULL);
write_nullable_type(W = #argo_core_writer{}, non_null, false) ->
    write_label(W, ?ARGO_LABEL_MARKER_NON_NULL);
write_nullable_type(W = #argo_core_writer{}, non_null, true) ->
    W;
write_nullable_type(W = #argo_core_writer{}, error, IsLabeled) when is_boolean(IsLabeled) ->
    write_label(W, ?ARGO_LABEL_MARKER_ERROR).
