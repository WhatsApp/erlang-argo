...
%%%-----------------------------------------------------------------------------
-module(argo_graphql_language_object_type_definition).
-moduledoc """
...
-type t() :: #argo_graphql_language_object_type_definition{}.
...
-spec parse(Context, Location) -> ObjectTypeDefinition when
    Context :: context(), Location :: erl_anno:location(), ObjectTypeDefinition :: t().
...
is_ambiguous(#argo_graphql_language_object_type_definition{fields = none}) ->
    true;
is_ambiguous(#argo_graphql_language_object_type_definition{fields = {some, _}}) ->
    false.
...
format(Formatter1, #argo_graphql_language_object_type_definition{
    name = Name,
    description = OptionDescription,
    implements = OptionImplements,
    directives = OptionDirectives,
    ...
    Formatter3 = argo_graphql_formatter:write(Formatter2, "type ~ts", [Name]),
    Formatter4 =
