...
%%%-----------------------------------------------------------------------------
-module(argo_graphql_language_fragment_spread).
-moduledoc """
...
-type t() :: #argo_graphql_language_fragment_spread{}.
...
parse(Context = #{name := FragmentName = #argo_graphql_language_fragment_name{}}, Location) ->
    OptionDirectives =
...
format(Formatter1, #argo_graphql_language_fragment_spread{
    name = FragmentName,
    directives = OptionDirectives
}) ->
