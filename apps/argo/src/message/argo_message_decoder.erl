...
-spec read_core_nullable_type(MessageDecoder, IsLabeled) -> {MessageDecoder, NullableType} when
    MessageDecoder :: t(), IsLabeled :: boolean(), NullableType :: argo_core:nullable_type().
read_core_nullable_type(MessageDecoder1 = #argo_message_decoder{core = Core1}, IsLabeled) when is_boolean(IsLabeled) ->
    {Core2, NullableType} = argo_core_reader:read_nullable_type(Core1, IsLabeled),
    MessageDecoder2 = MessageDecoder1#argo_message_decoder{core = Core2},
    {MessageDecoder2, NullableType}.
