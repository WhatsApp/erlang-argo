                ...
                case OptionBlock of
                    ...
                    {some, _} ->
                        error_with_info(badarg, [Header, BlockWireType, OptionBlock], #{
                            3 => unsupported_inline_block_encoder_must_have_empty_block
                        })
                end;
            false ->
...
decode_fixed(
    ...
    case argo_scalar_wire_type:is_fixed(Of) of
        true ->
            Length = Of#argo_fixed_wire_type.length,
            case Kind0 of
                #argo_dedupe_block_decoder{} ->
                    error_with_info(badarg, [BlockDecoder1, CoreReader1], #{
                        1 => {unsupported_dedupe_block_decoder_scalar_wire_type, Of}
...
decode_scalar(
    BlockDecoder1 = #argo_block_encoder{}, CoreReader1 = #argo_core_reader{}, ScalarWireType = #argo_scalar_wire_type{}
) ->
...
format_error_description(_Key, unsupported_inline_block_encoder_must_have_empty_block) ->
